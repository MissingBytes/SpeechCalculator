...
public abstract class ForwardingListener implements OnTouchListener {
    ...
    class C01591 implements OnAttachStateChangeListener {
        C01591() {
        }
    ...
    class C01602 implements OnGlobalLayoutListener {
    ...
    private void addDetachListenerApi12(View src) {
        src.addOnAttachStateChangeListener(new C01591());
    }

    private void addDetachListenerBase(View src) {
        src.getViewTreeObserver().addOnGlobalLayoutListener(new C01602());
    }
