...
public class ButtonBarLayout extends LinearLayout {
    ...
    public ButtonBarLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        boolean allowStackingDefault = getResources().getConfiguration().screenHeightDp >= ALLOW_STACKING_MIN_HEIGHT_DP;
        TypedArray ta = context.obtainStyledAttributes(attrs, C0141R.styleable.ButtonBarLayout);
        this.mAllowStacking = ta.getBoolean(C0141R.styleable.ButtonBarLayout_allowStacking, allowStackingDefault);
        ta.recycle();
    }
    ...
    private void setStacked(boolean stacked) {
        ...
        View spacer = findViewById(C0141R.id.spacer);
        if (spacer != null) {
