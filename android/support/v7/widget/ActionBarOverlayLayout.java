...
public class ActionBarOverlayLayout extends ViewGroup implements DecorContentParent, NestedScrollingParent {
    static final int[] ATTRS = new int[]{C0141R.attr.actionBarSize, 16842841};
    ...
    public ActionBarOverlayLayout(Context context, AttributeSet attrs) {
        ...
        this.mTopAnimatorListener = new C01481();
        this.mRemoveActionBarHideOffset = new C01492();
        this.mAddActionBarHideOffset = new C01503();
        init(context);
    ...
    void pullChildren() {
        if (this.mContent == null) {
            this.mContent = (ContentFrameLayout) findViewById(C0141R.id.action_bar_activity_content);
            this.mActionBarTop = (ActionBarContainer) findViewById(C0141R.id.action_bar_container);
            this.mDecorToolbar = getDecorToolbar(findViewById(C0141R.id.action_bar));
        }
    }
