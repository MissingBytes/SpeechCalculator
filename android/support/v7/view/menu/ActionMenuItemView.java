...
public class ActionMenuItemView extends AppCompatTextView implements ItemView, OnClickListener, ActionMenuChildView {
    ...
    public ActionMenuItemView(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, C0141R.styleable.ActionMenuItemView, defStyle, 0);
        this.mMinWidth = a.getDimensionPixelSize(C0141R.styleable.ActionMenuItemView_android_minWidth, 0);
        a.recycle();
    ...
    private void updateTextButtonVisibility() {
        ...
        if (TextUtils.isEmpty(contentDescription)) {
            setContentDescription(this.mItemData.getTitle());
        } else {
        ...
        if (TextUtils.isEmpty(tooltipText)) {
            ...
            ViewCompat.setTooltipText(this, charSequence2);
            return;
        }
