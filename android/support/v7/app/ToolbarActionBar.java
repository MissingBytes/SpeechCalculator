...
class ToolbarActionBar extends ActionBar {
    ...
    private final OnMenuItemClickListener mMenuClicker = new C02222();
    private final Runnable mMenuInvalidator = new C01401();
    ...
    class C02222 implements OnMenuItemClickListener {
        C02222() {
        }
...
*/
    ...
    private void ensureListMenuPresenter(Menu menu) {
        if (this.mListMenuPresenter == null && (menu instanceof MenuBuilder)) {
            ...
            this.mListMenuPresenter = new ListMenuPresenter(context2, C0141R.layout.abc_list_menu_item_layout);
