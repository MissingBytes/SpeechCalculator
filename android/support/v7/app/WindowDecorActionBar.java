...
public class WindowDecorActionBar extends ActionBar implements ActionBarVisibilityCallback {
    ...
    final ViewPropertyAnimatorListener mHideListener = new C02381();
    ...
    final ViewPropertyAnimatorListener mShowListener = new C02392();
    private boolean mShowingForMode;
    ScrollingTabContainerView mTabScrollView;
    private ArrayList<TabImpl> mTabs = new ArrayList();
    private Context mThemedContext;
    final ViewPropertyAnimatorUpdateListener mUpdateListener = new C02233();

    class C02233 implements ViewPropertyAnimatorUpdateListener {
        C02233() {
        }
    ...
    class C02381 extends ViewPropertyAnimatorListenerAdapter {
        C02381() {
        }
    ...
    class C02392 extends ViewPropertyAnimatorListenerAdapter {
        C02392() {
        }
    ...
    private void init(View decor) {
        this.mOverlayLayout = (ActionBarOverlayLayout) decor.findViewById(C0141R.id.decor_content_parent);
        if (this.mOverlayLayout != null) {
            this.mOverlayLayout.setActionBarVisibilityCallback(this);
        }
        this.mDecorToolbar = getDecorToolbar(decor.findViewById(C0141R.id.action_bar));
        this.mContextView = (ActionBarContextView) decor.findViewById(C0141R.id.action_context_bar);
        this.mContainerView = (ActionBarContainer) decor.findViewById(C0141R.id.action_bar_container);
        ...
        TypedArray a = this.mContext.obtainStyledAttributes(null, C0141R.styleable.ActionBar, C0141R.attr.actionBarStyle, 0);
        if (a.getBoolean(C0141R.styleable.ActionBar_hideOnContentScroll, false)) {
            setHideOnContentScrollEnabled(true);
        }
        int elevation = a.getDimensionPixelSize(C0141R.styleable.ActionBar_elevation, 0);
        if (elevation != 0) {
    ...
    public Context getThemedContext() {
        if (this.mThemedContext == null) {
            ...
            this.mContext.getTheme().resolveAttribute(C0141R.attr.actionBarWidgetTheme, outValue, true);
