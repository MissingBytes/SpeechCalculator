...
abstract class ModernAsyncTask<Params, Progress, Result> {
    ...
    private static final ThreadFactory sThreadFactory = new C00251();
    ...
    private final WorkerRunnable<Params, Result> mWorker = new C01882();

    static class C00251 implements ThreadFactory {
    ...
    class C01882 extends WorkerRunnable<Params, Result> {
        C01882() {
        }
