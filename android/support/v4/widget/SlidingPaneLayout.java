...
public class SlidingPaneLayout extends ViewGroup {
    ...
    static class SavedState extends AbsSavedState {
        public static final Creator<SavedState> CREATOR = ParcelableCompat.newCreator(new C02161());
        boolean isOpen;

        static class C02161 implements ParcelableCompatCreatorCallbacks<SavedState> {
            C02161() {
            }
