...
class TransportMediatorJellybeanMR2 {
    OnAudioFocusChangeListener mAudioFocusChangeListener = new C00644();
    boolean mAudioFocused;
    final AudioManager mAudioManager;
    final Context mContext;
    boolean mFocused;
    final OnGetPlaybackPositionListener mGetPlaybackPositionListener = new C00655();
    final Intent mIntent;
    final BroadcastReceiver mMediaButtonReceiver = new C00633();
    PendingIntent mPendingIntent;
    int mPlayState = 0;
    final OnPlaybackPositionUpdateListener mPlaybackPositionUpdateListener = new C00666();
    final String mReceiverAction;
    final IntentFilter mReceiverFilter;
    RemoteControlClient mRemoteControl;
    final View mTargetView;
    final TransportMediatorCallback mTransportCallback;
    final OnWindowAttachListener mWindowAttachListener = new C00611();
    final OnWindowFocusChangeListener mWindowFocusListener = new C00622();

    class C00611 implements OnWindowAttachListener {
        C00611() {
        }
    ...
    class C00622 implements OnWindowFocusChangeListener {
        C00622() {
        }
    ...
    class C00633 extends BroadcastReceiver {
        C00633() {
        }
    ...
    class C00644 implements OnAudioFocusChangeListener {
        C00644() {
        }
    ...
    class C00655 implements OnGetPlaybackPositionListener {
        C00655() {
        }
    ...
    class C00666 implements OnPlaybackPositionUpdateListener {
        C00666() {
        }
