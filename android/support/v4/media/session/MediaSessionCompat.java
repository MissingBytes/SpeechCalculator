...
public class MediaSessionCompat {
    ...
    public static final class QueueItem implements Parcelable {
        public static final Creator<QueueItem> CREATOR = new C00751();
        public static final int UNKNOWN_ID = -1;
        private final MediaDescriptionCompat mDescription;
        private final long mId;
        private Object mItem;

        static class C00751 implements Creator<QueueItem> {
            C00751() {
            }
    ...
    static final class ResultReceiverWrapper implements Parcelable {
        public static final Creator<ResultReceiverWrapper> CREATOR = new C00761();
        private ResultReceiver mResultReceiver;

        static class C00761 implements Creator<ResultReceiverWrapper> {
            C00761() {
            }
    ...
    public static final class Token implements Parcelable {
        public static final Creator<Token> CREATOR = new C00771();
        private final Object mInner;

        static class C00771 implements Creator<Token> {
            C00771() {
            }
    ...
    class C01981 extends Callback {
        C01981() {
        }
    }

    class C01992 extends Callback {
        C01992() {
        }
    }
    ...
    static class MediaSessionImplBase implements MediaSessionImpl {
        ...
        final String mTag;
        private final Token mToken;
        private android.support.v4.media.VolumeProviderCompat.Callback mVolumeCallback = new C02001();
        ...
        class C02001 extends android.support.v4.media.VolumeProviderCompat.Callback {
            C02001() {
            }
    ...
    static class MediaSessionImplApi18 extends MediaSessionImplBase {
        ...
        class C00731 implements OnPlaybackPositionUpdateListener {
            C00731() {
            }
        ...
        public void setCallback(Callback callback, Handler handler) {
            ...
            this.mRcc.setPlaybackPositionUpdateListener(new C00731());
        }
    ...
    static class MediaSessionImplApi19 extends MediaSessionImplApi18 {
        ...
        class C00741 implements OnMetadataUpdateListener {
            C00741() {
            }
        ...
        public void setCallback(Callback callback, Handler handler) {
            ...
            this.mRcc.setMetadataUpdateListener(new C00741());
        }
