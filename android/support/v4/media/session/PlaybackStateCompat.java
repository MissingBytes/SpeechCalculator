...
public final class PlaybackStateCompat implements Parcelable {
    ...
    public static final Creator<PlaybackStateCompat> CREATOR = new C00791();
    ...
    static class C00791 implements Creator<PlaybackStateCompat> {
        C00791() {
        }
    ...
    public static final class CustomAction implements Parcelable {
        public static final Creator<CustomAction> CREATOR = new C00801();
        ...
        static class C00801 implements Creator<CustomAction> {
            C00801() {
            }
