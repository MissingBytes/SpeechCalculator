...
public class ListFragment extends Fragment {
    ...
    View mListContainer;
    boolean mListShown;
    private final OnItemClickListener mOnClickListener = new C00232();
    View mProgressContainer;
    private final Runnable mRequestFocus = new C00221();
    ...
    class C00232 implements OnItemClickListener {
        C00232() {
        }
