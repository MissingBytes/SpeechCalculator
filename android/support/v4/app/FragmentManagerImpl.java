...
final class FragmentManagerImpl extends FragmentManager implements Factory2 {
    ...
    int mCurState = 0;
    boolean mDestroyed;
    Runnable mExecCommit = new C00061();
...
*/
    ...
    L_0x017b:
        ...
        r0 = r18;
        r5 = r5.append(r0);
        r6 = " declared target fragment ";
        r5 = r5.append(r6);
        r0 = r18;
        r6 = r0.mTarget;
        r5 = r5.append(r6);
        r6 = " that does not belong to this FragmentManager!";
        r5 = r5.append(r6);
        r5 = r5.toString();
        r4.<init>(r5);
        throw r4;
    ...
    L_0x02c0:
        ...
        if (r4 != 0) goto L_0x030d;
    L_0x02c6:
        r4 = r18.getResources();	 Catch:{ NotFoundException -> 0x043f }
        r0 = r18;
        r5 = r0.mContainerId;	 Catch:{ NotFoundException -> 0x043f }
        r14 = r4.getResourceName(r5);	 Catch:{ NotFoundException -> 0x043f }
    L_0x02d2:
        r4 = new java.lang.IllegalArgumentException;
        r5 = new java.lang.StringBuilder;
        r5.<init>();
    ...
    public void setPrimaryNavigationFragment(Fragment f) {
        if (f == null || (f.getFragmentManager() == this && f.mIndex < this.mActive.size() && this.mActive.get(f.mIndex) == f)) {
            this.mPrimaryNav = f;
            return;
        }
