...
public class ViewPager extends ViewGroup {
    ...
    private static final Comparator<ItemInfo> COMPARATOR = new C00981();
    ...
    private static final Interpolator sInterpolator = new C00992();
    ...
    private final Runnable mEndScrollRunnable = new C01003();
    ...
    static class C00981 implements Comparator<ItemInfo> {
        C00981() {
        }
    ...
    class C02074 implements OnApplyWindowInsetsListener {
        private final Rect mTempRect = new Rect();
    ...
    public static class SavedState extends AbsSavedState {
        public static final Creator<SavedState> CREATOR = ParcelableCompat.newCreator(new C02081());
        Parcelable adapterState;
        ClassLoader loader;
        int position;

        static class C02081 implements ParcelableCompatCreatorCallbacks<SavedState> {
            C02081() {
            }
    ...
    void initViewPager() {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(this, new C02074());
    }
